...
main = \
    Pool([
        Pool([
            ...
            Pool([
                Item(2, Item.itemType.const), Item('a', Item.itemType.non_const), Item('b', Item.itemType.non_const), Item('a', Item.itemType.non_const)
            ], Operator.operatorType.mul),
            Pool([
...
pow.parse(main.args[0].args[1])
print(main.args[0].args[1].args[1].special_parameters, main.args[0].args[1].args[1].value, len(main.args[0].args[1].args))
